...
public class CommandSwitchGame implements CommandInterface {
	...
	public String execute(String[] params) {
		...
		return "Game mode was switched!";
	}

	@Override
	public String help() {
		return "switch - switching game mode between game world and main menu";
	}
}
