...
public class MagicianCharacterFactory implements CharacterFactory {
	...
	public CharacterInterface construct(String name) {
		CharacterInterface character = new MagicianCharacter(name,
				(double) 1000);

		ItemInterface item1 = new BasicItem("Health", (double) 147, true);
